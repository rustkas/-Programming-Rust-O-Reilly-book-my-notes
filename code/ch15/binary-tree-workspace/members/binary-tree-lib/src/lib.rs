...
mod tests {
    ...
    fn test_external_iterator() {
        ...
        let left_subtree = make_node(BinaryTree::Empty, "mecha", BinaryTree::Empty);
        let right_subtree = make_node(
            make_node(BinaryTree::Empty, "droid", BinaryTree::Empty),
            "robot",
            BinaryTree::Empty,
        );
